      ...
      <div className="panel overflow-hidden">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center p-12 text-center">
            ...
            <h3 className="text-lg font-medium">Nenhum paciente na fila!</h3>
          ...
          <div className="divide-y divide-border">
            {appointments.map((apt) => (
              <div key={apt.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 gap-4 hover:bg-accent/50 transition-colors">
                
                <div className="flex items-center gap-4">
                  <div className="flex flex-col items-center justify-center bg-background border border-border rounded-lg p-2 min-w-[70px]">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="size-12 rounded-full bg-primary/10 flex items-center justify-center text-primary shrink-0 overflow-hidden">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground flex items-center gap-2 mt-0.5">
                        <span className="flex items-center gap-1"><Stethoscope className="size-3" /> {apt.procedures?.name || 'Consulta'}</span>
                        <span>•</span>
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  <span className={cn(
                    ...
                    apt.status === 'scheduled' ? "bg-accent text-foreground" :
                  ...
                  <Link
                    ...
                    className="flex-1 sm:flex-none flex items-center justify-center gap-2 h-10 px-4 rounded-md bg-primary text-primary-foreground font-medium text-sm hover:bg-primary/90 transition-colors"
                  >
